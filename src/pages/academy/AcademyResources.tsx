    ...
    <AcademyLayout>
      <div className="max-w-5xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-foreground/50 text-sm mt-1">Plantillas, checklists y roadmaps descargables.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {resources?.map((resource: any) => (
            ...
            >
              ...
              <p className="text-xs text-foreground/40 mb-4">{resource.description}</p>
              <button className="flex items-center gap-2 text-xs font-semibold transition-colors text-accent hover:opacity-80">
